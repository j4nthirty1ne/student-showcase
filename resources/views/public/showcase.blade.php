...
══════════════════════════════════════════════════════════ --}}
        @guest
            <section id="hero-slider" class="ss-hero-section relative w-full overflow-hidden"
                style="height:100svh;min-height:520px;">

                {{-- Background art --}}
                <div class="absolute inset-0 -z-10">
                    <img src="/images/hero_bg.png" alt="" class="w-full h-full object-cover opacity-60">
                    <div class="absolute inset-0"
                        style="background: linear-gradient(135deg, #030d12 0%, #0f3d35 40%, #0d1a3a 100%); opacity: 0.75;"></div>
                    {{-- Animated orbs --}}
                    <div class="ss-orb"
                        style="width:520px;height:520px;top:-100px;left:-120px;background:radial-gradient(circle,#0d9488 0%,transparent 70%);opacity:.18;animation:orbFloat 8s ease-in-out infinite;">
                    </div>
                    <div class="ss-orb"
                        style="width:400px;height:400px;bottom:-80px;right:-100px;background:radial-gradient(circle,#0f766e 0%,transparent 70%);opacity:.15;animation:orbFloat 11s ease-in-out infinite reverse;">
                    </div>
                    <div class="ss-orb"
                        style="width:300px;height:300px;top:40%;left:55%;background:radial-gradient(circle,#0891b2 0%,transparent 70%);opacity:.12;animation:orbFloat 14s ease-in-out infinite;">
                    </div>
                </div>
                         ...
                         backdrop-blur-md border"
                            ...
                            <h1 class="ss-slide-title font-black leading-tight mb-5 text-white"
                                ...
                                @else
                                    Build, Share &amp;<br>
                                    <span
                                        style="background:linear-gradient(90deg,#2dd4bf,#34d399,#22d3ee);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;">
                                        Inspire
                                    </span>
                                @endif
                            </h1>
                            ...
                            <p class="max-w-xl text-lg font-medium mb-10" style="color:rgba(255,255,255,.55);">
                                @if ($proj)
                                    ...
                                    @endif
                                @else
                                    A curated gallery of innovation, creativity, and breakthroughs from the next generation of
                                    makers.
                                @endif
                            </p>
                ...
                <div class="absolute bottom-10 left-1/2 -translate-x-1/2 flex gap-2 z-20" id="ss-dots">
                    @foreach ($slides as $i => $proj)
                        <button data-index="{{ $i }}" data-dot="{{ $i }}"
                            class="ss-dot rounded-full transition-all duration-300" @style([
            ...
            {{-- Scroll arrow --}}
            <a href="#stats" class="absolute bottom-10 right-8 z-20 flex flex-col items-center gap-1 group"
...
══════════════════════════════════════════════════════════ --}}
        @auth
            ...
            @endphp
            <section class="ss-dashboard-section relative w-full overflow-hidden"
                style="min-height:100svh;display:flex;flex-direction:column;justify-content:center;">

                {{-- Background --}}
                <div class="absolute inset-0 -z-10">
                    <img src="/images/hero_bg.png" alt="" class="w-full h-full object-cover opacity-40">
                    <div class="absolute inset-0"
                        style="background:linear-gradient(135deg,#030d12 0%,#0f3d35 40%,#0d1a3a 100%);opacity:.85;"></div>
                    <div class="ss-orb"
                        style="width:520px;height:520px;top:-100px;left:-120px;background:radial-gradient(circle,#0d9488 0%,transparent 70%);opacity:.18;animation:orbFloat 8s ease-in-out infinite;">
                    </div>
                    <div class="ss-orb"
                ...
                <div class="relative z-10 w-full max-w-7xl mx-auto px-6"
                    ...
                    <div>
                        <span
                            class="ss-dashboard-badge inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-md border"
                            style="background:rgba(13,148,136,.15);border-color:rgba(13,148,136,.4);color:#5eead4;">
                    ...
                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;">
                        ...
                        <div class="flex flex-col items-center justify-center py-10 px-3 text-center rounded-2xl"
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-widest"
                                style="color:rgba(255,255,255,.4);">Total</span>
                        </div>
                        {{-- Published --}}
                        <div class="flex flex-col items-center justify-center py-10 px-3 text-center rounded-2xl"
                            style="background:rgba(10,15,46,.75);border:1px solid rgba(255,255,255,.09);backdrop-filter:blur(20px);">
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-widest"
                                style="color:rgba(255,255,255,.4);">Published</span>
                        </div>
                        {{-- Pending --}}
                        <div class="flex flex-col items-center justify-center py-10 px-3 text-center rounded-2xl"
                            style="background:rgba(10,15,46,.75);border:1px solid rgba(255,255,255,.09);backdrop-filter:blur(20px);">
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-widest"
                                style="color:rgba(255,255,255,.4);">Pending</span>
                        </div>
                    </div>
                </div>

                {{-- Scroll hint --}}
                <a href="#stats" class="absolute bottom-10 right-8 z-20 flex flex-col items-center gap-1"
                    style="color:rgba(255,255,255,.4);">
                    <span class="text-[10px] uppercase tracking-widest font-bold">Scroll</span>
                    <i data-lucide="chevrons-down" class="w-5 h-5 animate-bounce"></i>
                </a>
        ...
        <section id="stats" class="relative z-10">
            <div class="max-w-5xl mx-auto px-6 -translate-y-8">
                <div class="grid grid-cols-3 gap-px rounded-2xl overflow-hidden shadow-2xl"
                    ...
                    @foreach ([['icon' => 'folder-open', 'val' => $totalProjects, 'label' => 'Projects Published'], ['icon' => 'users', 'val' => $totalStudents, 'label' => 'Student Builders'], ['icon' => 'tag', 'val' => $totalCategories, 'label' => 'Categories']] as $stat)
                        <div class="flex flex-col items-center justify-center py-8 px-4 text-center"
                            ...
                            <span class="text-xs font-bold uppercase tracking-widest"
                                style="color:rgba(255,255,255,.4);">{{ $stat['label'] }}</span>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <section id="ss-recent" class="py-16 px-6">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex items-end justify-between mb-10 flex-wrap gap-4">
                        <div>
                            <p class="text-xs font-black uppercase tracking-widest mb-2" style="color:#2dd4bf;">Featured Work
                            </p>
                        ...
                        <div class="flex gap-3">
                            <a href="#projects"
                                class="px-5 py-2.5 rounded-xl text-sm font-bold transition-all hover:scale-105"
                                style="background:rgba(13,148,136,.12);color:#2dd4bf;border:1px solid rgba(13,148,136,.25);">
                                Browse All
                            </a>
                            <a href="#projects"
                                class="px-5 py-2.5 rounded-xl text-sm font-bold transition-all hover:scale-105 text-white"
                        ...
                        @foreach ($recentProjects as $rp)
                            <a href="{{ route('project.show', $rp) }}"
                                ...
                                <div
                                    ...
                                    <span
                                        class="flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold text-white"
...
══════════════════════════════════════════════════════════ --}}
        <div class="w-full overflow-hidden py-5 border-y"
            style="border-color:rgba(13,148,136,.15);background:rgba(13,148,136,.04);">
            <div class="ss-marquee whitespace-nowrap text-xs font-black uppercase tracking-[0.3em]"
                style="color:rgba(45,212,191,.5);">
                @for ($m = 0; $m < 3; $m++)
                    &nbsp;&nbsp;&nbsp;✦ Student Innovation &nbsp;&nbsp;&nbsp;✦ Real Projects &nbsp;&nbsp;&nbsp;✦ Open Source
                    &nbsp;&nbsp;&nbsp;✦ Code &bull; Design &bull; Build &nbsp;&nbsp;&nbsp;✦ Next Generation Makers
                    &nbsp;&nbsp;&nbsp;✦ Cambodia Tech Future&nbsp;&nbsp;&nbsp;
                @endfor
            </div>
        </div>
        ...
        <section id="projects" class="py-20 px-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="relative max-w-3xl mx-auto mb-14">
                    <div class="absolute -inset-1 rounded-3xl blur-xl"
                        style="background:linear-gradient(90deg,rgba(13,148,136,.2),rgba(15,118,110,.2),rgba(8,145,178,.2));">
                    </div>
                    <form action="{{ route('home') }}" method="GET"
                        ...
                        @if (request()->hasAny(['search', 'category', 'technology']))
                            <a href="{{ route('home') }}" class="p-3 rounded-xl transition-all hover:scale-[1.02]"
        ...
        <section id="ss-testimonials" class="py-20 px-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @foreach ([['quote' => 'This platform gave me the confidence to share my capstone project with the world. The feedback was incredible!', 'name' => 'Sokha R.', 'role' => 'Computer Science, Year 4'], ['quote' => 'I found two amazing collaborators for my open-source project just by being on this showcase. Highly recommend submitting!', 'name' => 'Vicheth L.', 'role' => 'Software Engineering, Year 3'], ['quote' => 'Being featured here helped me land my first internship. The portfolio visibility is unmatched for students in our program.', 'name' => 'Sreyleap P.', 'role' => 'Information Technology, Year 4']] as $testimonial)
                        <div class="relative rounded-2xl p-7"
                            ...
                            {{-- Quote mark --}}
                            <div class="text-6xl font-black leading-none mb-4" style="color:rgba(45,212,191,.25);">&ldquo;
                            </div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs font-medium" style="color:rgba(148,163,184,.6);">
                                        {{ $testimonial['role'] }}</p>
                                </div>
                            </div>
                        </div>
...
══════════════════════════════════════════════════════════ --}}
        <section class="py-20 px-6">
            <div class="max-w-4xl mx-auto rounded-3xl overflow-hidden relative"
                ...
                <div
                    style="position:absolute;width:320px;height:320px;top:-80px;right:-60px;background:radial-gradient(circle,rgba(15,118,110,.3) 0%,transparent 70%);pointer-events:none;">
                </div>
                <div
                    style="position:absolute;width:200px;height:200px;bottom:-40px;left:-40px;background:radial-gradient(circle,rgba(8,145,178,.2) 0%,transparent 70%);pointer-events:none;">
                </div>
                ...
                <div class="relative z-10 px-10 py-16 text-center">
                    ...
                    <h2 class="text-3xl md:text-5xl font-black text-white mb-4 leading-tight tracking-tight">
                        ...
                        <span
                            style="background:linear-gradient(90deg,#5eead4,#34d399);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;">next
                            big idea?</span>
                    </h2>
                    <p class="text-base font-medium mb-10"
                        style="color:rgba(255,255,255,.55);max-width:480px;margin-left:auto;margin-right:auto;">
            ...
            <div class="max-w-7xl mx-auto px-6 py-16">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                    ...
                    <div class="lg:col-span-1">
                        <div class="flex items-center gap-2.5 mb-4">
                            ...
                            <span class="font-black text-white text-lg tracking-tight">ProjectForge</span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            @foreach ([['label' => 'Browse Projects', 'href' => route('home')], ['label' => 'Submit a Project', 'href' => Route::has('register') ? route('register') : '#'], ['label' => 'Sign In', 'href' => Route::has('login') ? route('login') : '#']] as $link)
                                <li>
                                    <a href="{{ $link['href'] }}"
                                        class="text-sm font-medium transition-all hover:translate-x-1 inline-flex items-center gap-1.5"
                                        style="color:rgba(255,255,255,.45);" onmouseover="this.style.color='#5eead4'"
                ...
                <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4"
                    ...
                    <p class="text-xs font-medium" style="color:rgba(255,255,255,.25);">
                        &copy; {{ date('Y') }} ProjectForge. Built with ❤️ by students, for students.
                    </p>
...
══════════════════════════════════════════════════════════ --}}
        <style>
            ...
            .ss-btn-primary:hover {
                ...
                box-shadow: 0 12px 40px rgba(13, 148, 136, .55) !important;
            }
            ...
            html.light .ss-page-wrap {
                background: #f0fdfa;
            }

            /* ══ HERO & DASHBOARD (dark by default) ════════════════ */
            .ss-hero-section,
            .ss-dashboard-section {
                background: #0a071a;
            }
            ...
            html.light .ss-hero-section h1 {
                color: #0c2926 !important;
                text-shadow: none !important;
            }

            html.light .ss-hero-section p[style*="rgba(255,255,255"] {
                color: #475569 !important;
            }

            html.light .ss-hero-section .ss-btn-outline {
                border-color: rgba(13, 148, 136, .35) !important;
                color: #0f766e !important;
                background: rgba(13, 148, 136, .08) !important;
            }

            html.light .ss-hero-section .absolute>div[style*="gradient"] {
                opacity: 0 !important;
            }

            html.light .ss-hero-section .absolute>img {
                opacity: .05 !important;
            }

            html.light .ss-hero-section .ss-orb {
                opacity: .35 !important;
            }

            html.light .ss-hero-section span[style*="rgba(13,148,136,.15)"] {
            ...
            html.light .ss-dashboard-section h1 {
                color: #0c2926 !important;
                text-shadow: none !important;
            }

            html.light .ss-dashboard-badge {
                color: #0b524e !important;
                border-color: rgba(13, 148, 136, .5) !important;
                background: rgba(13, 148, 136, .12) !important;
            }

            html.light .ss-dashboard-section .text-white {
                color: #0c2926 !important;
            }

            html.light .ss-dashboard-section p[style*="rgba(255,255,255"] {
                color: #475569 !important;
            }

            html.light .ss-dashboard-section span[style*="rgba(255,255,255"] {
                color: #64748b !important;
            }

            html.light .ss-dashboard-section .ss-btn-outline {
                border-color: rgba(13, 148, 136, .35) !important;
                color: #0f766e !important;
                background: rgba(13, 148, 136, .08) !important;
            }
            ...
            html.light .ss-dashboard-section i[data-lucide="folder"] {
                color: #0d9488 !important;
            }

            html.light .ss-dashboard-section i[data-lucide="check-circle-2"] {
                color: #059669 !important;
            }

            html.light .ss-dashboard-section i[data-lucide="clock"] {
                color: #d97706 !important;
            }

            html.light .ss-dashboard-section .absolute>div[style*="gradient"] {
                opacity: 0 !important;
            }

            html.light .ss-dashboard-section .absolute>img {
                opacity: .04 !important;
            }

            html.light .ss-dashboard-section .ss-orb {
                opacity: .3 !important;
            }
            ...
            html.light #stats .text-white {
                color: #0c2926 !important;
            }

            html.light #stats [style*="rgba(255,255,255,.4"] {
                color: #64748b !important;
            }
            ...
            html.light #ss-recent h2.text-white {
                color: #0c2926 !important;
            }

            html.light #ss-recent h3.text-white {
                color: #0c2926 !important;
            }
            ...
            html.light #ss-recent [style*="rgba(255,255,255,.4"] {
                color: #64748b !important;
            }

            html.light #ss-recent [style*="rgba(255,255,255,.1"] {
            ...
            html.light #projects h3 {
                color: #0c2926 !important;
            }

            html.light #projects .text-white {
                color: #0c2926 !important;
            }

            html.light #projects p[style*="rgba(255,255,255"] {
                color: #64748b !important;
            }
            ...
            html.light #projects input {
                color: #0f172a !important;
                background: transparent;
            }

            html.light #projects select {
                background: rgba(240, 252, 250, .9) !important;
                color: #0f172a !important;
            }
            ...
            html.light #projects [style*="rgba(148,163,184"] {
                color: #64748b !important;
            }

            html.light #projects time {
                color: #64748b !important;
            }

            html.light #projects [style*="rgba(255,255,255,.25)"] {
                color: #94a3b8 !important;
            }

            /* ══ TESTIMONIALS (#ss-testimonials) ══════════════════ */
            html.light #ss-testimonials h2.text-white {
                color: #0c2926 !important;
            }

            html.light #ss-testimonials .text-white {
                color: #0c2926 !important;
            }
            ...
            html.light #ss-testimonials [style*="rgba(45,212,191,.25)"] {
                color: rgba(13, 148, 136, .45) !important;
            }

            html.light #ss-testimonials [style*="rgba(255,255,255,.65)"] {
                color: #475569 !important;
            }

            html.light #ss-testimonials [style*="rgba(148,163,184"] {
                color: #64748b !important;
            }
            ...
            html.light footer [style*="rgba(255,255,255,.4"] {
                color: #64748b !important;
            }

            html.light footer [style*="rgba(255,255,255,.45)"],
            html.light footer a[style*="rgba(255,255,255"] {
                color: #0d7a6e !important;
            }

            html.light footer [style*="rgba(255,255,255,.25)"] {
                color: #94a3b8 !important;
            }

            html.light footer a[style*="rgba(45,212,191"] {
                color: #0d9488 !important;
            }

            html.light footer [style*="border-top"] {
                border-color: rgba(13, 148, 136, .15) !important;
            }

            html.light footer li[style] {
                color: #94a3b8 !important;
            }
        </style>
