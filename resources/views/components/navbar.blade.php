...
<nav id="main-nav"
    ...
    <div class="max-w-7xl mx-auto px-5 h-16 flex items-center justify-between gap-4">
        ...
        <a href="{{ route('home') }}"
           class="flex items-center gap-2.5 flex-shrink-0 group">
            <div class="w-8 h-8 rounded-xl flex items-center justify-center transition-transform duration-200 group-hover:scale-110"
                 style="background:linear-gradient(135deg,#0d9488,#0f766e);box-shadow:0 4px 16px rgba(13,148,136,.4);">
            ...
            <span class="font-black text-white tracking-tight text-base hidden sm:block">
                Student<span style="color:#2dd4bf;">Showcase</span>
            </span>
        </a>
        ...
        <div class="flex items-center gap-2 flex-shrink-0">
            ...
            <div class="relative" id="nav-user-menu">
                <button id="nav-user-btn"
                    ...
                    <i data-lucide="chevron-down" class="w-3.5 h-3.5 text-white/40 hidden sm:block transition-transform duration-200" id="nav-chevron"></i>
                </button>

                {{-- Dropdown --}}
                <div id="nav-dropdown"
                     class="absolute right-0 top-full mt-2 w-52 rounded-2xl overflow-hidden hidden"
                    ...
                    <div class="px-4 py-3 border-b" style="border-color:rgba(255,255,255,.06);">
                        ...
                        <p class="text-[10px] font-medium truncate" style="color:rgba(255,255,255,.35);">{{ Auth::user()->email }}</p>
                    </div>
                    <div class="py-1.5">
                        <a href="{{ route('student.dashboard') }}"
    ...
    <div id="nav-mobile-menu"
         class="md:hidden hidden px-5 pb-4"
